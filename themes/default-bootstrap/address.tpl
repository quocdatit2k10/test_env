...
<ul class="footer_links clearfix">
	<li>
	    <a  class="btn btn-defaul button button-small"
	        href="{if $back}{$link->getPageLink('order', true, NULL, 'step=1')|escape:'html':'UTF-8'}
	              {else}{$link->getPageLink('addresses', true, NULL, '')|escape:'html':'UTF-8'}{/if}" >
